...
1. Local canonical workflow source (`skills/skill-writer/SKILL.md` and `skills/skill-writer/references/*.md`).
2. Anthropic/Claude upstream skill-authoring source (for example `anthropics/skills/.../skill-creator` or the published GitHub path).
3. Agent Skills specification and repository conventions.
